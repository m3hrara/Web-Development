...
app.patch("/jokes/:id", (req,res)=>{
  let id = parseInt(req.params.id);
  jokes[id-1].jokeText = req.body.text || jokes[id-1].jokeText;
  jokes[id-1].jokeType = req.body.type || jokes[id-1].jokeType;
...
app.delete("/jokes/:id", (req,res)=>{
  ...
  if(id>=0 && id<= jokes.length){
    ...
    jokes.splice(id-1, 1);
    res.send(`jokes number ${id} was deleted`);
  } else{
    res.send(`number ${id} is out of range`);
  }
});
//8. DELETE All jokes
